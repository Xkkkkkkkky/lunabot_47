...
vlive_group_sub = SekaiGroupSubHelper("live", "虚拟Live通知", ENABLED_SERVER_REGIONS)
vlive_user_sub = SekaiUserSubHelper("live", "虚拟Live@提醒", ENABLED_SERVER_REGIONS, related_group_sub=vlive_group_sub)
